...
The linked file (link:label_agg_level.csv[] ) has columns indicating exactly which detailed variables are included.  Columns <<geo_level,geo_level>> and <<ind_level,ind_level>> are explained above.


[width="90%",format="csv",cols=">1,3*<2,14*<1",options="header"]
|===================================================
include::label_agg_level.csv[]
|===================================================
...
<<<
*******************
This revision: Fri May 15 11:55:01 EDT 2015
*******************
