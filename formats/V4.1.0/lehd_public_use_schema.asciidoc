= LEHD Public Use Data Schema V4.1.0
...
==== In more detail
  ...
  - added agg_level variable 89617e3,
  ...
  - Added a extension component [ext] to the file naming convention to reflect availability of Excel files (and PDF files) d9f8387
  ...
  - Added Federal government to files  (for National QWI) 942dd0a,
  - Clarified description of filenaming components 8888529,
...
<<<
*******************
This revision: Fri Oct  7 14:24:08 EDT 2016
*******************
