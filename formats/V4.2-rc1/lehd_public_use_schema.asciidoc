= LEHD Public Use Data Schema V4.2-rc1
...
- Added J2Japp description of metadata for convenience
- Added a column "ind_level" to label_industry.csv similar to the geo_level
- Added additional columns to the variable metadata schema:
  - Description,
  - Concept,
  - Base
...
<<<
*******************
This revision: Mon Dec 18 12:39:45 EST 2017
*******************
